        ...
        <div class="col-12">
            ...
            ?>            
                <div class="card-content">
                    <div class="card-body">
                        <form class="form" data-parsley-validate action="<?php echo $template['form']['action'];?>" enctype="multipart/form-data" method="post" id="frm_teacher" name="frm_teacher">
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group mandatory <?php echo  form_error('nip') ?'is-invalid' : '' ?>">
                                        <label for="nip" class="form-label">NIP</label>
                                        <input type="text" class="form-control" placeholder="NIP" data-parsley-required="true" name="nip" id="nip" value="<?php echo $method == 'post' ? set_value('nip') : $data['teacher']->nip;?>" required>
                                    <?php 
                                        echo form_error('nip');
                                    ?>    
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group mandatory <?php echo  form_error('name') ?'is-invalid' : '' ?>">
                                        ...
                                        <input type="text" class="form-control" placeholder="Name" data-parsley-required="true" name="name" id="name" value="<?php echo $method == 'post' ? set_value('name') : $data['teacher']->name;?>" required>
                                    <?php 
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group mandatory <?php echo  form_error('birth_date') ?'is-invalid' : '' ?>">
                                        ...
                                        <input type="text" class="form-control datepicker"  placeholder="Date of birth" data-parsley-required="true" name="birth_date" id="birth_date" value="<?php echo $method == 'post' ? set_value('birth_date') : $data['teacher']->birth_date;?>" required>
                                    <?php 
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group mandatory <?php echo  form_error('gender') ?'is-invalid' : '' ?>">
                                        ...
                                        */?>
                                        ...
                                        <option value=''></option>
                                        <option value='M' <?php echo $method == 'post' ? set_select('gender', 'M') : ($data['teacher']->gender == 'M' ? 'selected' : ''); ?>>Male</option>
                                        <option value='F' <?php echo  $method == 'post' ? set_select('gender', 'F') : ($data['teacher']->gender == 'F' ? 'selected' : ''); ?>>Female</option>
                                    </select>
                                    <?php 
                                ...
                                <div class="col-md-6 col-12">
                                        <div class="form-group <?php echo  form_error('phone_number') ?'is-invalid' : '' ?>">
                                            ...
                                            <input type="text" class="form-control" placeholder="Phone Number" name="phone_number" id="phone_number" value="<?php echo $method == 'post' ? set_value('phone_number') : $data['teacher']->phone_number;?>" >
                                        <?php 
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group mandatory <?php echo  form_error('address') ?'is-invalid' : '' ?>">
                                        ...
                                        <textarea class="form-control" placeholder="Address" data-parsley-required="true" id="address" name="address" style="height: 92px;" required><?php echo $method == 'post' ? set_value('address') : $data['teacher']->address;?></textarea>
                                    <?php 
