        ...
        <div class="col-12">
            ...
            ?>            
                <div class="card-content">
                    <div class="card-body">
                        <form class="form" data-parsley-validate action="<?php echo $template['form']['action'];?>" enctype="multipart/form-data" method="post" id="frm_administrator" name="frm_administrator">
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group <?php echo  form_error('phone_number') ?'is-invalid' : '' ?>">
                                        <label for="nip" class="form-label">Phone Number</label>
                                        <input type="text" class="form-control" placeholder="Phone Number" name="phone_number" id="phone_number" value="<?php echo $method == 'post' ? set_value('phone_number') : $data['administrator']->phone_number;?>" >
                                    <?php 
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group mandatory <?php echo  form_error('name') ?'is-invalid' : '' ?>">
                                        ...
                                        <input type="text" class="form-control" placeholder="Name" data-parsley-required="true" name="name" id="name" value="<?php echo $method == 'post' ? set_value('name') : $data['administrator']->name;?>" required>
                                    <?php 
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group mandatory <?php echo  form_error('birthplace') ?'is-invalid' : '' ?>">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="hidden" class="form-control" placeholder="Birthplace" name="birthplace" id="birthplace" value="<?php echo $method == 'post' ? set_value('birthplace') : $data['administrator']->birthplace_id;?>" data-form= "<?php echo $method == 'post' ? set_value('birthplace-select_text') : $data['administrator']->birthplace_name;?>" data-form-autocomplete-url="<?php echo site_url('city/json_search')?>" required >
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group mandatory <?php echo  form_error('birth_date') ?'is-invalid' : '' ?>">
                                        ...
                                        <input type="text" class="form-control datepicker"  placeholder="Date of birth" data-parsley-required="true" name="birth_date" id="birth_date" value="<?php echo $method == 'post' ? set_value('birth_date') : $data['administrator']->birth_date;?>" required>
                                    <?php 
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group mandatory <?php echo  form_error('religion') ?'is-invalid' : '' ?>">
                                        ...
                                        <input type="hidden" class="form-control" placeholder="Religion" name="religion" id="religion" value="<?php echo $method == 'post' ? set_value('religion'): $data['administrator']->religion_id;?>" data-parsley-required="true" data-form="<?php echo $method == 'post' ? set_value('religion-select_text') : $data['administrator']->religion_name;?>" data-form-autocomplete-url="<?php echo site_url('religion/json_search')?>" required> 
                                    <?php 
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group mandatory <?php echo  form_error('gender') ?'is-invalid' : '' ?>">
                                        ...
                                        */?>
                                        ...
                                        <option value=''></option>
                                        <option value='M' <?php echo $method == 'post' ? set_select('gender', 'M') : ($data['administrator']->gender == 'M' ? 'selected' : ''); ?>>Male</option>
                                        <option value='F' <?php echo  $method == 'post' ? set_select('gender', 'F') : ($data['administrator']->gender == 'F' ? 'selected' : ''); ?>>Female</option>
                                    </select>
                                    <?php 
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group mandatory <?php echo  form_error('address') ?'is-invalid' : '' ?>">
                                        ...
                                        <textarea class="form-control" placeholder="Address" data-parsley-required="true" id="address" name="address" style="height: 92px;" required><?php echo $method == 'post' ? set_value('address') : $data['administrator']->address;?></textarea>
                                    <?php 
