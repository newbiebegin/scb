                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group mandatory <?php echo  form_error('father_name') ?'is-invalid' : '' ?>">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Father's Name" data-parsley-required="true" name="father_name" id="father_name" value="<?php echo set_value('father_name');?>" required>
                                                <?php 
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group <?php echo  form_error('father_phone_number') ?'is-invalid' : '' ?>">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Father's Phone Number" name="father_phone_number" id="father_phone_number" value="<?php echo set_value('father_phone_number');?>" >
                                                <?php 
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group mandatory <?php echo  form_error('father_address') ?'is-invalid' : '' ?>">
                                                    ...
                                                    <textarea class="form-control" placeholder="Father's Address" data-parsley-required="true" id="father_address" name="father_address" style="height: 92px;" required><?php echo set_value('father_address');?></textarea>
                                                <?php 
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group mandatory <?php echo  form_error('mother_name') ?'is-invalid' : '' ?>">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Mother's Name" data-parsley-required="true" name="mother_name" id="mother_name" value="<?php echo set_value('mother_name');?>" required>
                                                <?php 
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group <?php echo  form_error('mother_phone_number') ?'is-invalid' : '' ?>">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Mother's Phone Number" name="mother_phone_number" id="mother_phone_number" value="<?php echo set_value('mother_phone_number');?>" >
                                                <?php 
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group mandatory <?php echo  form_error('mother_address') ?'is-invalid' : '' ?>">
                                                    ...
                                                    <textarea class="form-control" placeholder="Mother's Address" data-parsley-required="true" id="mother_address" name="mother_address" style="height: 92px;" required><?php echo set_value('mother_address');?></textarea>
                                                <?php 
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group mandatory <?php echo  form_error('code') ?'is-invalid' : '' ?>">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Code" data-parsley-required="true" name="code" id="code" value="<?php echo set_value('code');?>" required>
                                                <?php 
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group mandatory <?php echo  form_error('student_guardian_name') ?'is-invalid' : '' ?>">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Student Guardian's Name" data-parsley-required="true" name="student_guardian_name" id="student_guardian_name" value="<?php echo set_value('student_guardian_name');?>" required>
                                                <?php 
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group <?php echo  form_error('student_guardian_phone_number') ?'is-invalid' : '' ?>">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Student Guardian's Phone Number" name="student_guardian_phone_number" id="student_guardian_phone_number" value="<?php echo set_value('student_guardian_phone_number');?>" >
                                                <?php 
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group mandatory <?php echo  form_error('student_guardian_address') ?'is-invalid' : '' ?>">
                                                    ...
                                                    <textarea class="form-control" placeholder="Student Guardian's Address" data-parsley-required="true" id="student_guardian_address" name="student_guardian_address" style="height: 92px;" required><?php echo set_value('student_guardian_address');?></textarea>
                                                <?php 
                                            ...
                                            <div class="col-12">
                                                <div class="form-group mandatory <?php echo  form_error('photo') ?'is-invalid' : '' ?>">
                                                    ...
                                                    <input type="file" class="form-control" placeholder="Student Guardian's Photo" data-parsley-required="true" name="photo" id="photo" value="<?php echo set_value('photo');?>" required>
                                                <?php 
